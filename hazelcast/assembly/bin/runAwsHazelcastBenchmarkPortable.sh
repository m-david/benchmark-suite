...
JMH_OPTS="-wi 1 -t 80 -i 1 -f 1 -r 60 -gc true  -rf json -rff $WORK_DIRECTORY/hazelcast.$TODAY.$APP_PID.json -o $WORK_DIRECTORY/hazelcast.$TODAY.$APP_PID.txt -jvmArgsAppend -ea"

COMMAND_LINE="java $JAVA_OPTS -cp $CLASS_PATH org.openjdk.jmh.Main PortableSerializableBenchmark $JMH_OPTS"
echo $COMMAND_LINE
$COMMAND_LINE
