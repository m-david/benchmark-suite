...
-Dtangosol.coherence.proxy.address=172.30.0.205 \
...
JMH_OPTS="-wi 1 -t 8 -i 1 -f 1 -r 60 -gc true  -rf json -rff $APP_HOME/results/coherence.$TODAY.$APP_PID.json -o $APP_HOME/results/coherence.$TODAY.$APP_PID.txt -jvmArgsAppend -ea"
